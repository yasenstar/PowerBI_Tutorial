# Part 1 - Chapter 03: Oh, the Choices: Power BI Versions
...
| --- | --- | --- |
| Data Handling Capacity | <ul> <li>Limited to approximately 1 million rows per worksheet</li> <li>Performance degradeds with large datasets</li> <li>Manual refresh processes for external data connections</li> <li>Best suited for datasets under 100K rows</li> </ul> | <ul> <li>Can handle millions of rows efficiently</li> <li>Optimized for big data processing</li> <li>Automatic data refresh capabilities</li> <li>Compressed data storage reduces file size significantly</li> </ul> |
| Data Source Connectivity | <ul> <li>Connects to databases, web services, and files</li> <li>Limited real-time data connections</li> <li>Requires manual setup for most connections</li> <li>Best with static or infrequently updated data</li> </ul> | <ul> <li>100+ native connectors</li> <li>Real-time streaming data support</li> <li>Cloud and on-premises data integration</li> <li>Automatic data gateway for secure connections</li> </ul> |
